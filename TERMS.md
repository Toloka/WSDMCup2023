# Individual Terms and Conditions for the WSDM Cup 2023 Visual Question Answering Challenge (hereinafter referred to as the “Contest”)
...
- Private Test Set. The Public Test set is constructed in the same manner as the Train set, but it is not released to the participants (they are available to the Organizer).
